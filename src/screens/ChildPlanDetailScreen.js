    ...
    <SafeAreaView style={styles.safe} edges={[]}>
      ...
      <LinearGradient colors={['#1B3D2F', '#0D2419']} style={[styles.hero, { paddingTop: insets.top + 12 }]}>
        ...
        <View style={styles.childBadge}>
          ...
          <Text style={styles.childBadgeText}>Child Development Plan · Age {plan.childAge}</Text>
        </View>
      ...
      <ScrollView ref={scrollRef} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {isComplete && (
          <View style={styles.completionBanner}>
            ...
            <Text style={styles.completionDays}>You completed the {plan.durationDays}-day {plan.journeyType} journey for your child.</Text>
            {plan.parentReminder ? (
            ...
            <TouchableOpacity
              ...
              onPress={() => navigation.replace('ChildPlanWizard')}
              activeOpacity={0.85}
            >
          ...
          <>
            ...
            {currentPhase && (
              <View style={styles.phaseInfoCard}>
                <Ionicons name="map-outline" size={15} color="#2E7D62" style={{ marginTop: 1 }} />
...
const styles = StyleSheet.create({
  ...
  phaseInfoBold: { fontWeight: '700', color: '#1B3D2F' },
  ...
  completionBanner: {
    backgroundColor: '#1B3D2F', borderRadius: 20, padding: 24,
  ...
  completionBtn: { backgroundColor: '#4ADE80', borderRadius: 14, paddingVertical: 14, paddingHorizontal: 32 },
  completionBtnText: { fontSize: 15, fontWeight: '700', color: '#1B3D2F' },
  checkInBtn: {
